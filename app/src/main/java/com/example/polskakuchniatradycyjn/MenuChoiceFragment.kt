...
class MenuChoiceFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.gotoweDaniaButton.setOnClickListener {
            findNavController().navigate(
                MenuChoiceFragmentDirections.actionMenuChoiceFragment2ToReadyMealFragment()
            )
        }
        binding.wlasneDaniaButton.setOnClickListener {
            findNavController().navigate(
                MenuChoiceFragmentDirections.actionMenuChoiceFragment2ToCustomMealFragment()
            )
        }
